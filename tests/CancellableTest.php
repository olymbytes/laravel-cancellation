...
use Olymbytes\Cancellation\Test\Traits\FindsOrders;
...
class CancellableTest extends TestCase
{
    ...
    function cancelling_an_order_fires_expected_events()
    {
        ...
        Event::assertDispatched('eloquent.cancelling: Olymbytes\Cancellation\Test\Models\Order');
        Event::assertDispatched('eloquent.cancelled: Olymbytes\Cancellation\Test\Models\Order');
    }
    ...
    function keeping_an_order_fires_expected_events()
    {
        ...
        Event::assertDispatched('eloquent.keeping: Olymbytes\Cancellation\Test\Models\Order');
        Event::assertDispatched('eloquent.kept: Olymbytes\Cancellation\Test\Models\Order');
    }
